-- INSERT INTO TABLE_USER (FIRST_NAME, LAST_NAME, USERNAME, PASSWORD, IS_ACTIVE, LAST_LOGIN, LAST_BAD_LOGIN, BAD_LOGIN_COUNT) VALUES ('Admin','User', 'sa', 'sa', 0, NULL, NULL, 0);

-- INSERT INTO TABLE_ROLE (ROLE_NAME) VALUES ('ADMIN');
-- INSERT INTO TABLE_ROLE (ROLE_NAME) VALUES ('EMPLOYEE');
